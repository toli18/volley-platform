...
export default function TrainingDetails() {
  ...
  const trainingPlanText = data?.trainingPlanText || "";
  const planDrillCount = useMemo(() => {
    let n = 0;
  ...
  return (
    <div className="wrap">
      ...
      {data.notes &&
      data.notes !== "Generated by hybrid-v1" &&
      !String(data.notes).startsWith("Домашна текстова") ? (
        <div className="sectionBox" style={{ background: "#fff" }}>
