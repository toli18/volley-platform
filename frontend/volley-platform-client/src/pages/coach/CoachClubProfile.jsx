    ...
    <div className="uiPage clubProfilePage">
      ...
      {activeTab === "school_excuse" && isHead ? (
        <Card title="Извинителни бележки за училище">
          <p className="uiMuted" style={{ marginTop: 0, fontSize: 13, lineHeight: 1.45 }}>
            Настройте шаблоните, подписа и печата веднъж. Родителите изтеглят PDF от профила: за
            състезания (потвърден състав) и/или годишна бележка за занималня по седмичния график на
            тренировки.
          </p>
