...
Налични са два листа:
  ...
  • Момчета  14–15 г.  → прилагаме за male,   възрасти U13 и U14
    (числата са измервани на 14–15 г., но федерацията събира набора U13–U14,
     затова летвата се прилага за U13–U14 — симетрично с момичетата)
...
# --- Момчета 14–15 г. (male; прилага се за U13 и U14 — наборът на федерацията) ---
...
_COVERAGE: list[tuple[str, tuple[str, ...], dict[str, GradeBands]]] = [
    ...
    # Числата са от лист „момчета 14–15", но прилагаме летвата за U13–U14 —
    # това е наборът, който федерацията събира (U15 момчета не влизат в набора).
    ("male", ("U13", "U14"), _BOYS_14_15),
]
...
def reference_age_band(gender: Optional[str]) -> Optional[str]:
    ...
    сравнява срещу тази летва (female → U13, male → U13). Връща None, ако полът
