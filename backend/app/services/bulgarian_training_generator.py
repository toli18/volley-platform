...
_SKILL_SYNONYMS: Dict[str, Tuple[str, ...]] = {
    ...
    "Разпределение": ("разпределение", "разпределяне", "пас", "разиграване", "setting", "подаване", "подач", "passing", "pass"),
    "Сервис": ("сервис", "начален удар", "serve", "service"),
    "Атака": ("атака", "нападение", "attack"),
    "Блок": ("блок", "block"),
    "Защита": ("защита", "defense", "диг"),
    "Преход": ("преход", "transition", "контра", "counter", "контраатака"),
    "Координация": ("координация", "coordination", "ловкост", "отскок", "скок", "сила", "физическ", "плиометр"),
    "Игра": ("игра", "game", "rally", "игрова", "ситуация"),
}
