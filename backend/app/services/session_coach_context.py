...
def load_training_session_pack(
    ...
    prompt_lines.extend(
        [
            ...
            "- Контекстът е фон; отговаряй с треньорски знания — човешки, не като меню.",
            "- При ясен технически въпрос (отскок, заход, сила) — отговори директно, без „кое упражнение“.",
            "- Ако треньорът каже име на упражнение — дай cues/опростяване за НЕГО.",
            "- При трудност: опростяване, прогресия, алтернатива, какво да каже на терена.",
